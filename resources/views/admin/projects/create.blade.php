    ...
    <form action="{{ route('admin.projects.store') }}" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <textarea name="short_description"
                      ...
                      required
                      maxlength="500"
                      class="w-full px-4 py-2 bg-rose-pine-surface text-rose-pine-text border border-rose-pine-base/30 rounded-lg focus:outline-none focus:border-rose-pine-gold @error('short_description') border-rose-pine-love @enderror">{{ old('short_description') }}</textarea>
        ...
        <div>
            ...
            <textarea name="description"
                      id="description"
                      rows="8"
                      class="w-full px-4 py-2 bg-rose-pine-surface text-rose-pine-text border border-rose-pine-base/30 rounded-lg focus:outline-none focus:border-rose-pine-gold @error('description') border-rose-pine-love @enderror">{{ old('description') }}</textarea>
            @error('description')
            <p class="mt-1 text-sm text-rose-pine-love">{{ $message }}</p>
            @enderror
