...
<div class="max-w-4xl mx-auto">
    <!-- Header -->
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-rose-pine-text">Create New Project</h1>
        <p class="text-rose-pine-subtle mt-2">Fill in the details below to create a new portfolio project.</p>
    </div>
    ...
    <form action="{{ route('admin.projects.store') }}" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <textarea name="short_description"
                      ...
                      required
                      maxlength="500"
                      class="w-full px-4 py-2 bg-rose-pine-surface text-rose-pine-text border border-rose-pine-highlight-med rounded-lg focus:outline-none focus:border-rose-pine-iris @error('short_description') border-rose-pine-love @enderror">{{ old('short_description') }}</textarea>
        ...
        <div>
            ...
            <textarea name="description"
                      id="description"
                      rows="8"
                      class="w-full px-4 py-2 bg-rose-pine-surface text-rose-pine-text border border-rose-pine-highlight-med rounded-lg focus:outline-none focus:border-rose-pine-iris @error('description') border-rose-pine-love @enderror">{{ old('description') }}</textarea>
            @error('description')
            <p class="mt-1 text-sm text-rose-pine-love">{{ $message }}</p>
            @enderror
        ...
        <!-- Tech Stack -->
        <div x-data="{
            tags: {{ json_encode(old('tech_stack', [])) }},
            newTag: '',
            addTag() {
            ...
            <div class="flex gap-2 mb-2">
                <input type="text"
                       ...
                       class="flex-1 px-4 py-2 bg-rose-pine-surface text-rose-pine-text border border-rose-pine-highlight-med rounded-lg focus:outline-none focus:border-rose-pine-iris">
                <button type="button"
                        @click="addTag()"
            ...
            <div class="flex flex-wrap gap-2 min-h-[40px] p-3 bg-rose-pine-surface border border-rose-pine-highlight-med rounded-lg">
                <template x-for="(tag, index) in tags" :key="index">
                    <div class="flex items-center gap-1 px-3 py-1 bg-rose-pine-iris bg-opacity-20 text-rose-pine-iris rounded-full text-sm">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <select name="status"
                        id="status"
                        required
                        class="w-full px-4 py-2 bg-rose-pine-surface text-rose-pine-text border border-rose-pine-highlight-med rounded-lg focus:outline-none focus:border-rose-pine-iris @error('status') border-rose-pine-love @enderror">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="url"
                       ...
                       class="w-full px-4 py-2 bg-rose-pine-surface text-rose-pine-text border border-rose-pine-highlight-med rounded-lg focus:outline-none focus:border-rose-pine-iris @error('live_url') border-rose-pine-love @enderror">
                @error('live_url')
                <p class="mt-1 text-sm text-rose-pine-love">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="url"
                       ...
                       class="w-full px-4 py-2 bg-rose-pine-surface text-rose-pine-text border border-rose-pine-highlight-med rounded-lg focus:outline-none focus:border-rose-pine-iris @error('github_url') border-rose-pine-love @enderror">
                @error('github_url')
                <p class="mt-1 text-sm text-rose-pine-love">{{ $message }}</p>
                @enderror
            </div>
        ...
        <div>
            ...
            <input type="text"
                   ...
                   class="w-full px-4 py-2 bg-rose-pine-surface text-rose-pine-text border border-rose-pine-highlight-med rounded-lg focus:outline-none focus:border-rose-pine-iris @error('thumbnail') border-rose-pine-love @enderror">
            @error('thumbnail')
            <p class="mt-1 text-sm text-rose-pine-love">{{ $message }}</p>
            @enderror
