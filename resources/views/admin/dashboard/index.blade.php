    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-rose-pine-surface border border-rose-pine-highlight-low rounded-lg p-6 hover:border-rose-pine-foam transition-colors duration-200">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-rose-pine-subtle text-sm font-medium">Total Projects</p>
                    <p class="text-3xl font-bold text-rose-pine-text mt-2">{{ $stats['total_projects'] }}</p>
                </div>
            ...
            <a href="{{ route('admin.projects.index') }}" class="text-rose-pine-foam text-sm mt-4 inline-block hover:underline">
                Manage projects →
            </a>
        </div>
        ...
        <div class="bg-rose-pine-surface border border-rose-pine-highlight-low rounded-lg p-6 hover:border-rose-pine-iris transition-colors duration-200">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-rose-pine-subtle text-sm font-medium">Blog Posts</p>
            ...
            <p class="text-rose-pine-subtle text-xs mt-4">Git-based publishing</p>
        </div>
