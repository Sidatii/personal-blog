...
<div class="max-w-4xl mx-auto">
    <!-- Header -->
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-rose-pine-text">Create New Post</h1>
        <p class="text-rose-pine-subtle mt-2">Fill in the details below to create a new blog post.</p>
    </div>
    ...
    <form action="{{ route('admin.posts.store') }}" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <textarea name="excerpt"
                      id="excerpt"
                      rows="3"
                      class="w-full px-4 py-2 bg-rose-pine-surface text-rose-pine-text border border-rose-pine-base/30 rounded-lg focus:outline-none focus:border-rose-pine-gold @error('excerpt') border-rose-pine-love @enderror">{{ old('excerpt') }}</textarea>
            @error('excerpt')
            <p class="mt-1 text-sm text-rose-pine-love">{{ $message }}</p>
            @enderror
        ...
        <div>
            ...
            <textarea name="content"
                      ...
                      rows="20"
                      required
                      class="w-full px-4 py-2 bg-rose-pine-surface text-rose-pine-text border border-rose-pine-base/30 rounded-lg focus:outline-none focus:border-rose-pine-gold font-mono text-sm @error('content') border-rose-pine-love @enderror">{{ old('content') }}</textarea>
            @error('content')
            <p class="mt-1 text-sm text-rose-pine-love">{{ $message }}</p>
            @enderror
